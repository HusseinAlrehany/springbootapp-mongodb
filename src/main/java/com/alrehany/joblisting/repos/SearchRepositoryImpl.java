...
public class SearchRepositoryImpl implements  SearchRepository{
    ...
    public List<Post> findByText(String text) {
       ...
       final List<Post> posts = new ArrayList<>();
        ...
        MongoDatabase database = mongoClient.getDatabase("alrehany");
        ...
        //iterate over the result and add every document inside the posts
        //but first use mongo convertor to convert the document into java class
